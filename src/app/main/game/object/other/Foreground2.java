...
public class Foreground2 extends GameObject {
    private Image sprite;
    private Vector2 imageSize = new Vector2(80, 60);

    public Foreground2(GameScene owner, double posX, double posY) {
        super(owner);
        setLayer(ObjectLayer.Frontground);
        setPosition(posX, posY);
        setSize(imageSize.copy());
        sprite = AssetManager.getInstance().findImage("foreground2");
    }
